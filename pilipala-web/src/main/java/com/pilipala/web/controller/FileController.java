...
public class FileController extends ABaseController {
    ...
    public void videoResource(@PathVariable @NotEmpty String fileId, HttpServletResponse response) {
        ...
        videoPlayInfoDTO.setVideoId(videoFile.getVideoId());
        videoPlayInfoDTO.setFileIndex(videoFile.getFileIndex());
        UserTokenInfoDTO userTokenInfoDTO = getTokenInfoFromCookie();
        if (userTokenInfoDTO != null) {
            videoPlayInfoDTO.setUserId(userTokenInfoDTO.getId());
        }
