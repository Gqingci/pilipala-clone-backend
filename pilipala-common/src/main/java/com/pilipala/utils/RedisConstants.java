...
public class RedisConstants {
    ...
    public static final String REDIS_VIDEO_PLAY_QUEUE_KEY = REDIS_KEY_PREFIX + "queue:video:play:";
    ...
    public static final String REDIS_VIDEO_SEARCH_COUNT_KEY = REDIS_KEY_PREFIX + "video:search:";

    public static final String REDIS_VIDEO_PLAY_COUNT_KEY = REDIS_KEY_PREFIX + "video:playcount:";
}
