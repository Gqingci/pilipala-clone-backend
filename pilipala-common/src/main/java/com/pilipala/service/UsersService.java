...
public interface UsersService{
	...
	Users getUserDetail(String currentUserId, String userId);

	void updateUser(Users user, UserTokenInfoDTO userTokenInfoDTO);

    UserCountInfoDTO getUserCountInfo(String userId);

	void changeUserStatus(String userId, Integer status);

    void addCoins(String userId, int dailyLoginReward);
}