    ...
    public void saveAction(UserAction userAction) {
        ...
        switch (userActionTypeEnum) {
            ...
            case VIDEO_COLLECT:
                ...
                Integer changeCount = actionDB == null ? Constants.ONE : -Constants.ONE;
                ...
                if (userActionTypeEnum == UserActionTypeEnum.VIDEO_COLLECT) {
                    // 更新es的收藏数量
                    esSearchComponent.updateDocCount(video.getVideoId(), SearchOrderTypeEnum.VIDEO_COLLECT.getField(), changeCount);
                }
                break;
            case VIDEO_COIN:
