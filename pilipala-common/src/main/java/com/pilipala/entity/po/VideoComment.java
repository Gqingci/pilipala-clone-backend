...
public class VideoComment implements Serializable {
    ...
    public String toString() {
        return "评论ID:" + (commentId == null ? "空" : commentId) + ",父级评论ID:" + (pCommentId == null ? "空" : pCommentId) + ",视频ID:" + (videoId == null ? "空" : videoId) + ",视频用户ID:" + (videoUserId == null ? "空" : videoUserId) + ",回复内容:" + (content == null ? "空" : content) + ",图片:" + (imgPath == null ? "空" : imgPath) + ",用户ID:" + (userId == null ? "空" : userId) + ",回复人ID:" + (replyUserId == null ? "空" : replyUserId) + ",0:未置顶 1:置顶:" + (topType == null ? "空" : topType) + ",发布时间:" + (postTime == null ? "空" : DateUtils.format(postTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern())) + ",喜欢数量:" + (likeCount == null ? "空" : likeCount) + ",讨厌数量:" + (hateCount == null ? "空" : hateCount);
    }
